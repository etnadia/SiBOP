...
<head>
    ...
    <title>SiBOP-Sistem Informasi BOP</title>
    <!-- Custom CSS -->
            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    <div class="text-center p-t-5 p-b-5">
                        <span class="db"><img src="assets/images/LogoPAUD.png" alt="logo" width="25%"/></span>
                        <span class="db"><img src="assets/images/TextSiBOP.png" alt="logo" width="75%"/></span>
                   </div>
                    <?php
																			if ($_SERVER['REQUEST_METHOD'] == 'POST') {
																				...
																				if ($user == '' && $pass == '') {
																					?>
                              <div class="alert alert-warning" role="alert"><b>Warning !!</b> Form isian belum lengkap!</div>
                              <?php
                                ...
                                <?php
																												...
																												?>           
                    <!-- Form -->
                    <form class="form-horizontal m-t-20" id="loginform" action="" method="post" role="form">
